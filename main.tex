...
\vspace{-2mm}
\begin{itemize}
\item[]{\textit{Deep Learning Frameworks:} Keras, TensorFlow, NumPy}\vspace{-2mm}
\item[]{\textit{Languages:} Python, Java, JavaScript, HTML}\vspace{-2mm}
\item[]{\textit{Databases:} MySQL}\vspace{-2mm}
\item[]{\textit{Web Development Frameworks:} J2EE, Python Flask, jQuery, Twitter Bootstrap, Enyo JS}\vspace{-2mm}
